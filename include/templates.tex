...
\foreach \x in {1,...,7} {%
  \fbox{\includegraphics[width=0.24\textwidth, page=\x]{examples/apssamp.pdf}}
}
\end{frame}
...
\setlength{\fboxsep}{0pt}
\foreach \x in {1,...,8} {%
  \fbox{\includegraphics[width=0.24\textwidth, page=\x]{examples/fduthesis/fduthesis-template.pdf}}
}
\vspace{-0.8cm}
\end{frame}
