...
\usepackage{array,bookmark,ccicons,hologo,listings,multicol,qrcode,ragged2e,siunitx,unicode-math}
...
\newfontfamily\SourceHanSerifNoCJK{Source Han Serif SC ExtraLight}
...
\newfontfamily\EmojiOne{EmojiOneColor.otf}[Path=./fonts/, Ligatures=TeX]
...
\titlegraphic{%
  \vspace{3.4cm}
  \qrcode[hyperlink, height=1.6cm]{https://github.com/stone-zeng/latex-talk/}}
